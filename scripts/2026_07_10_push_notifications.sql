...
-- Run after profiles and admin helpers exist.

-- ---------------------------------------------------------------------------
-- user_notification_settings (one row per profile)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- push_tokens (multiple devices per profile)
-- ---------------------------------------------------------------------------
...
-- Inserts are performed by service role (edge function) only.
...
-- ---------------------------------------------------------------------------
-- Ensure settings row exists for a profile
-- ---------------------------------------------------------------------------
